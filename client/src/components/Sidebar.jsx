...
const Sidebar = ({closeToggle}) => {
    ...
    let categs = [
        ...
        {name:"Invoice Journal", link:"dev/InvoiceJournals",img:<BsFillJournalBookmarkFill fontSize={25} className='text-[#0ea5e9]'/>},
        {name:"Price List", link:"dev/PriceLists",img:<IoIosPricetags fontSize={25} className='text-[#ffa959]' />},
        {name:"Multiple Invoice", link:"dev/MultipleInvoices",img:<LiaFileInvoiceDollarSolid  fontSize={25} className='text-[#0ea5e9]'/>},
        {name:"Unpaid Invoices", link:"dev/UnpaidInvoices",img:<RxCrossCircled fontSize={25} className='text-[#ff5555]' />},
        {name:"Offer", link:"dev/Offers",img:<BiSolidOffer  fontSize={25} className='text-[#ffe96c]'/>},
        {name:"Inventory Control", link:"dev/InventoryControls",img:<MdInventory  fontSize={25} className='text-[#38ffff]'/>},
        {name:"Member Invoicing", link:"dev/MemberInvoices",img:<FaRegAddressCard fontSize={25} className='text-[#0ea5e9]' />},
        {name:"Import/Export", link:"dev/ImportExports",img:<MdImportExport fontSize={25} className='text-[#205b77]' />},
    ];
